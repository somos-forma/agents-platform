...
export const UserEditForm = ({ selectedUser }: UserEditFormProps) => {
  ...
  const { closeEditModal } = useUserStore();
  ...
  const mutation = useMutation({
    mutationFn: () => updateUser(selectedUser.id, form.getValues()),
    onSuccess: () => {
      closeEditModal();
      toast.success("Usuario actualizado exitosamente");
      queryClient.invalidateQueries({ queryKey: ["users"] });
      queryClient.invalidateQueries({ queryKey: ["userEditModal"] });
    },
    onError: (error) => {
